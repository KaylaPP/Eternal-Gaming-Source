...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'Gnormal':
				iconColor = "FF003399";
				frames = Paths.getSparrowAtlas('mr_gamer/GamerNormal', 'shared');
				animation.addByPrefix('idle', 'Mr.Gamer Idle', 24, false);
				animation.addByPrefix('singUP', 'Mr.Gamer up', 24, false);
				animation.addByPrefix('singDOWN', 'Mr.Gamer down', 24, false);
				animation.addByPrefix('singLEFT', 'Mr.Gamer left', 24, false);
				animation.addByPrefix('singRIGHT', 'Mr.Gamer right', 24, false);
